...
create table tb_movie (id bigint generated by default as identity, img_url varchar(255), sub_title varchar(255), synopsis TEXT, title varchar(255), year integer, genre_id bigint, primary key (id))
